...
/// SKK 20080416 moved to gcc we comment this
#if defined(__MSVC__)
...
extern void APIENTRY glutJoystickFunc(void (*func)(unsigned int buttonMask, int x, int y, int z, int r, int u, int v ), int pollInterval); /* ej */
#endif
#endif
#endif
